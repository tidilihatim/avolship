...
export enum StockMovementReason {
  ...
  CUSTOMER_UNREACHED = 'customer_unreached',
...
StockHistorySchema.methods.getMovementDescription = function(this: IStockHistory): string {
  const reasonMap: Record<StockMovementReason, string> = {
    ...
    [StockMovementReason.CUSTOMER_UNREACHED]: 'Customer unreachable - stock returned',
    [StockMovementReason.DELIVERY_FAILED]: 'Delivery failed - stock returned',
