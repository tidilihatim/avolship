...
interface AdminSellerAnalyticsClientProps {
  warehouses: Warehouse[];
  selectedWarehouseId?: string;
  children: React.ReactNode;
}

export function AdminSellerAnalyticsClient({
  warehouses,
  selectedWarehouseId,
  children,
}: AdminSellerAnalyticsClientProps) {
  const t = useTranslations('adminSellerAnalytics');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Date Range Filter */}
        <DateRangeFilter onDateRangeChange={handleDateRangeChange} defaultRange="thisyear" />
      </div>
