...
interface InactiveSellersChartProps {
  data: InactiveSellersData[];
  sellers: Seller[];
}
...
export function InactiveSellersChart({ data, sellers }: InactiveSellersChartProps) {
  const t = useTranslations('adminSellerAnalytics.charts.inactiveSellers');
