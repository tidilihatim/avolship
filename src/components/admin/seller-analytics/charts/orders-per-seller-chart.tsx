...
interface OrdersPerSellerChartProps {
  data: OrdersData[];
  sellers: Seller[];
  totalOrders: number;
...
export function OrdersPerSellerChart({
  data,
  sellers,
  totalOrders,
  selectedSellerId,
}: OrdersPerSellerChartProps) {
  const t = useTranslations('adminSellerAnalytics.charts.ordersPerSeller');
