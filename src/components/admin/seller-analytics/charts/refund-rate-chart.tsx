...
export function RefundRateChart({
  data,
  sellers,
  overallRate,
  totalOrders,
  refundedOrders,
  selectedSellerId,
}: RefundRateChartProps) {
  const t = useTranslations('adminSellerAnalytics.charts.refundRate');
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="mt-4 grid grid-cols-3 gap-4 border-t pt-4">
          ...
          <div className="text-center">
            <div className="text-sm text-muted-foreground">{t('refundedOrders')}</div>
            <div className="text-2xl font-bold text-red-600 dark:text-red-400">
