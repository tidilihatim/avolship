...
interface SellerDeliveryRateChartProps {
...
export function SellerDeliveryRateChart({
  data,
  sellers,
  overallRate,
  totalOrders,
  deliveredOrders,
  selectedSellerId,
}: SellerDeliveryRateChartProps) {
  const t = useTranslations('adminSellerAnalytics.charts.deliveryRate');
    ...
    <Card>
      ...
      <CardContent>
                    ...
                    formatter={(value, name, props) => {
                      ...
                      return [
                        <div key="tooltip-value" className="space-y-1">
                          <div>
                            <span className="font-medium">{value}%</span> {t('delivered')}
                          </div>
                          <div className="text-xs text-muted-foreground">
                            {payload.delivered} / {payload.total} {t('orders')}
                          </div>
                        </div>,
                        t('rate'),
                      ];
        ...
        <div className="mt-4 grid grid-cols-3 gap-4 border-t pt-4">
          ...
          <div className="text-center">
            <div className="text-sm text-muted-foreground">{t('deliveredOrders')}</div>
