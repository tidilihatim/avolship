...
import { EpicSeller } from '@/app/actions/admin-dashboard';

interface EpicSellersChartProps {
  data: EpicSeller[];
...
export function EpicSellersChart({
  data,
  onPeriodChange,
  currentPeriod = 'monthly',
  loading = false
}: EpicSellersChartProps) {
  const t = useTranslations('admin.dashboard.charts.epicSellers');
