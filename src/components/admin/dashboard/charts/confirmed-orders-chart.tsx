...
import { ConfirmedOrdersChart } from '@/app/actions/admin-dashboard';

interface ConfirmedOrdersChartProps {
...
export function ConfirmedOrdersChartComponent({ data }: ConfirmedOrdersChartProps) {
  const t = useTranslations('admin.dashboard.charts.confirmedOrders');
