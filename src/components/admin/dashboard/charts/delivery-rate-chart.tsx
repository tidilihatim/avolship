...
import { DeliveryRateChart } from '@/app/actions/admin-dashboard';
...
export function DeliveryRateChartComponent({ data }: DeliveryRateChartProps) {
  const t = useTranslations('admin.dashboard.charts.deliveryRate');
        ...
        <div className="w-full overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-chart-5 rounded-full flex-shrink-0" />
