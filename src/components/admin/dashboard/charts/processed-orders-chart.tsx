...
import { ProcessedOrdersChart } from '@/app/actions/admin-dashboard';
...
export function ProcessedOrdersChartComponent({ data }: ProcessedOrdersChartProps) {
  const t = useTranslations('admin.dashboard.charts.processedOrders');
      ...
      <CardContent>
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 border-t pt-4">
          <div className="space-y-1">
            <p className="text-sm font-medium text-muted-foreground">{t('totalProcessed')}</p>
