...
import { DeliveredOrdersChart } from '@/app/actions/admin-dashboard';

interface DeliveredOrdersChartProps {
...
export function DeliveredOrdersChartComponent({ data }: DeliveredOrdersChartProps) {
  const t = useTranslations('admin.dashboard.charts.deliveredOrders');
        ...
        <div className="w-full overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-chart-4 rounded-full flex-shrink-0" />
