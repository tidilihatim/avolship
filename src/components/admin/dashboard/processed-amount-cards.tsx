...
import { ProcessedAmountData } from '@/app/actions/admin-dashboard';
import { Loader2 } from 'lucide-react';

interface ProcessedAmountCardsProps {
...
export function ProcessedAmountCards({
  data,
  loading,
  onSellerChange,
  sellers
}: ProcessedAmountCardsProps) {
  const t = useTranslations('admin.dashboard.charts.processedAmount');
