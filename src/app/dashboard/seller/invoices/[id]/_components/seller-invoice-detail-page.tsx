...
export default function SellerInvoiceDetailPage({ invoice, orders, expeditions, refundOrders }: SellerInvoiceDetailPageProps) {
  ...
  // Transform data for DebtInvoicePreview
  const seller = {
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="invoice-preview-container">
        ...
        showSalesSummaryForSeller={true}
        preview={{
          ...
          totalExpeditionCosts: invoice.summary.totalExpeditionCosts || 0,
          ...
          previousDebtAmount: invoice.summary.previousDebtAmount || 0, // Show previous debt for transparency
          ...
          selectedExpeditions: expeditions.map(expedition => ({
            ...
            feePerKg: 0,
            totalCost: expedition.totalValue || 0,
            ...
            products: expedition.products?.map((product: any) => ({
              productName: product.productId?.name || product.productName || 'Unknown Product',
          ...
          refundData: refundOrders.map(refund => ({
            ...
            originalAmount: refund.totalPrice || 0,
            ...
            status: 'refunded',
            statusComment: refund.statusComment || refund.refundReason || undefined, // Prefer statusComment, fallback to refundReason
          })),
        }}
        configuration={{
