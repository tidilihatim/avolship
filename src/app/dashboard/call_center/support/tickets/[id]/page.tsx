...
export default async function CallCenterTicketPage({ params }: TicketPageProps) {
  ...
  if (!ticket) {
    redirect("/dashboard/call_center/support");
  }
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <nav className="text-sm text-muted-foreground">
          <a href="/dashboard/call_center/support" className="hover:text-primary">Support</a>
          {" / "}
