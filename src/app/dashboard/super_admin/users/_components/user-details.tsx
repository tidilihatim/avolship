...
export default function UserDetails({ user }: UserDetailsProps) {
  ...
  const getRoleConfig = (role: UserRole) => {
    const roleConfigs = {
      ...
      [UserRole.SUPER_ADMIN]: { label: "super_admin", description: t('users.roles.descriptions.admin'), className: 'bg-purple-50 text-purple-700 hover:bg-purple-50 border-purple-200' },
    };
